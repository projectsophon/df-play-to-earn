...
describe("RevealMarket", function () {
  ...
  it("Should revert if planet is already revealed", async function () {
    const revealPlanetReceipt = await darkForestCore.revealLocation(...validRevealProof2);
    ...
    const create = revealMarket.createRevealBounty(...validRevealProof2, overrides);
...
const validRevealProof2: RevealProof = [
  [
